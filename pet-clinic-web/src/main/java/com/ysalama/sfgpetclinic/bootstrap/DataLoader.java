...
import com.ysalama.sfgpetclinic.services.map.OwnerServiceMap;
import com.ysalama.sfgpetclinic.services.map.VetServiceMap;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Vet vet2 = new Vet();
        vet1.setId(2L);
        vet1.setFirstName("dqweqw");
        vet1.setLastName("qeqweqwe Sam");
